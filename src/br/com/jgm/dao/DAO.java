...
public class DAO extends AbstractDAO{
	...
	public Empresa getSituacaoEmpresa(String inscrMunicipal, String nome) {
		...
		String query = "select codi_emp, nome_emp, stat_emp from bethadba.geempre where imun_emp = '" + inscrMunicipal + "' and stat_emp  = 'A'";
		...
		try {
			...
			if (empresa.getCodigo() != null) {
				System.out.println(empresa.getInscrMunicipal() + " " +empresa.getNome());
			}
